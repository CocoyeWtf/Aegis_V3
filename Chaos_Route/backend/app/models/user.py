...
class User(Base):
    ...
    supplier_id: Mapped[int | None] = mapped_column(Integer, ForeignKey("suppliers.id"), nullable=True)  # Lien optionnel vers un fournisseur / Optional link to a supplier
