...
class ImportService:
    ...
    ENTITY_FIELDS: dict[str, list[str]] = {
        ...
        "volumes": ["pdv_id", "date", "nb_colis", "eqp_count", "weight_kg", "temperature_class", "base_origin_id", "preparation_start", "preparation_end", "dispatch_date", "dispatch_time", "activity_type", "promo_start_date"],
